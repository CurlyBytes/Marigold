										...
										<div class="row">
												...
												<div class="col mb-3">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control  <?php echo (form_error('locationname') ? 'is-invalid' : 'is-valid');?>" id="locationname" name="locationname" placeholder="Branch Name" value="<?php echo html_escape(set_value('locationname')); ?>">
