										...
										<div class="row">
												...
												<div class="col mb-3">
													<div class="form-group">
														...
														<input type="month" class="form-control  <?php echo (form_error('openingdate') ? 'is-invalid' : 'is-valid');?>" id="openingdate" name="openingdate" placeholder="Opening Date" value="<?php echo html_escape(set_value('openingdate', date('Y-m-d', strtotime($propose_branch->OpeningDate)))); ?>">
											...
											<div class="row">
												<div class="col mb-3">
													<div class="form-group">
														<label class="form-label" for="description">OtherDetails</label>
														...
														<textarea  class="form-control  <?php echo (form_error('description') ? 'is-invalid' : 'is-valid');?>" id="description" name="description" cols="20"  rows="2"> 
															<?php echo html_escape(set_value('description', $propose_branch_details->OtherDetails)); ?>
														</textarea>
