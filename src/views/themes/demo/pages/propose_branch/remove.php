											...
											<div class="row">
												<div class="col mb-3">
													<div class="form-group">
														...
														<input type="text" class="form-control  <?php echo (form_error('ratings') ? 'is-invalid' : 'is-valid');?>" id="ratings" name="ratings" placeholder="ratings" value="<?php echo html_escape(set_value('ratings', $propose_branch_details->Ratings)); ?>" readonly>
