			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Internet Service Provider - Modify</h1>

					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Internet Service Provider: form edit</h5>
								</div>
								<div class="card-body">

									<div class="column">
										<?php echo form_open('propose-branch/modify-isp/' . $propose_branch->BranchInformationId . '/' . $internetserviceprovider->InternetServiceProviderId); ?>
