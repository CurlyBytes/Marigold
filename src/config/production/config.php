...
|
*/
$config['base_url'] ="https://webapp-biozheid-qat-sea-2.azurewebsites.net/";
...
$config['csrf_token_name'] = 'csrf_token_marigold';
$config['csrf_cookie_name'] = 'csrf_cookie_marigold';
